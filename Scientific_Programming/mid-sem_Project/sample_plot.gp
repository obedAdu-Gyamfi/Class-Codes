...
plot "data.dat" using 1:2 title "Bisection Method" smooth csplines  with linespoint lt 7 lc 7 dt 1 lw 1,\
'' using 1:3 title "Secant Method" smooth csplines  with linespoint lt 7 lc 6 dt 1 lw 1,\
'' using 1:4 title "Newton Raphson Method" smooth csplines with linespoint lt 7 lc 2 dt 1 lw 1,\
'' using 1:5 title "Fixed Point Method" smooth csplines with linespoint lt 7 lc 8 dt 1 lw 1
